[lc-sdk-js](../README.md) › [Globals](../globals.md) › ["src/customer/structures"](../modules/_src_customer_structures_.md) › [ActivateChatParameters](_src_customer_structures_.activatechatparameters.md)
