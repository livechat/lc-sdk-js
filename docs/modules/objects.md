...
- [Agent](../interfaces/objects.Agent.md)
...
- [Customer](../interfaces/objects.Customer.md)
...
- [Geolocation](../interfaces/objects.Geolocation.md)
...
- [LastPage](../interfaces/objects.LastPage.md)
...
- [SessionField](../interfaces/objects.SessionField.md)
- [Statistics](../interfaces/objects.Statistics.md)
- [SystemMessage](../interfaces/objects.SystemMessage.md)
- [Thread](../interfaces/objects.Thread.md)
- [Visit](../interfaces/objects.Visit.md)
...
[objects/index.ts:124](https://github.com/livechat/lc-sdk-js/blob/7431f2f/src/objects/index.ts#L124)

___

### User

Ƭ **User**: [`Agent`](../interfaces/objects.Agent.md) \| [`Customer`](../interfaces/objects.Customer.md)

#### Defined in

[objects/index.ts:126](https://github.com/livechat/lc-sdk-js/blob/7431f2f/src/objects/index.ts#L126)
