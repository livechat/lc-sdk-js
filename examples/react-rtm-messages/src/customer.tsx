...
export async function initCustomerTokenGetter(licenseID: number, organizationID: string, clientID: string, redirectURI: string): Promise<TokenGetter> {
  ...
  try {
    ...
    return () => ({ accessToken, licenseID, region, tokenType });
  } catch (error) {
